    ...
    return (
        <div className="h-full bg-gray-200 p-8 flex flex-col">
            <div className="bg-white rounded-lg shadow-xl pb-8 w-full flex flex-col">
                <div className=" mt-4 rounded h-max relative">
                    <div className="absolute right-10 top-5 text-white">
                        <button onClick={() => setOpenSettings((prev) => !prev)} className="border border-gray-400 p-2 rounded text-gray-300 hover:text-gray-300 bg-gray-100 bg-opacity-10 hover:bg-opacity-20" title="Settings">
                        ...
                        {openSettings &&
                            <div className="bg-white absolute right-0 w-40 py-2 mt-1 border border-gray-200 shadow-2xl text-in">
                    ...
                    <div className="flex flex-col w-full items-center -mt-20">
                        <img src="https://vojislavd.com/ta-template-demo/assets/img/profile.jpg" className="w-52 object-cover border-4 border-white rounded-full" />
                    ...
                    <div className="flex-1 flex flex-col items-center lg:items-end justify-end px-8 mt-2">
                        <div className="flex items-center space-x-4 mt-2">
                            <button className="flex items-center bg-blue hover:bg-blue-700 text-gray-100 px-4 py-2 rounded text-sm space-x-2 transition duration-100">
                        ...
                        <div className="flex-1 bg-white rounded-lg shadow-xl mt-4 p-8">
                            ...
                            <div className="relative px-4">
                                ...
                                <div className="flex items-center w-full my-6 -ml-1.5">
                                    ...
                                    <div className="w-11/12">
                                        <p className="text-sm">
                                            Connected with <a href="#" className="text-blue font-bold">Colby Covington</a>.</p>
                                ...
                                <div className="flex items-center w-full my-6 -ml-1.5">
                                    ...
                                    <div className="w-11/12">
                                        <p className="text-sm">Invoice <a href="#" className="text-blue font-bold">#4563</a> was created.</p>
                                ...
                                <div className="flex items-center w-full my-6 -ml-1.5">
                                    ...
                                    <div className="w-11/12">
                                        <p className="text-sm">
                                            Message received from <a href="#" className="text-blue font-bold">Cecilia Hendric</a>.</p>
                                ...
                                <div className="flex items-center w-full my-6 -ml-1.5">
                                    ...
                                    <div className="w-11/12">
                                        <p className="text-sm">New order received <a href="#" className="text-blue font-bold">#OR9653</a>.</p>
                                ...
                                <div className="flex items-center w-full my-6 -ml-1.5">
                                    ...
                                    <div className="w-11/12">
                                        <p className="text-sm">
                                            Message received from <a href="#" className="text-blue font-bold">Jane Stillman</a>.</p>
                                        <p className="text-xs text-gray-500">2 hours ago</p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="flex flex-col w-full 2xl:w-2/3">
                        ...
                        <div className="flex-1 bg-white rounded-lg shadow-xl mt-4 p-8">
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-4">
                                ...
                                <div className="px-6 py-6 bg-gray-100 border border-gray-300 rounded-lg shadow-xl">
                                    <div className="flex items-center justify-between">
                                        <span className="font-bold text-sm text-blue">New Connections</span>
                                        <span className="text-xs bg-gray-200 hover:bg-gray-500 text-gray-500 hover:text-gray-200 px-2 py-1 rounded-lg transition duration-200 cursor-default">7 days</span>
                                    </div>
                                    <div className="flex items-center justify-between mt-6">
                                        <div>
                                            <svg className="w-12 h-12 p-2.5 bg-blue-400 bg-opacity-20 rounded-full text-blue border border-blue" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg>
                                        </div>
                                        <div className="flex flex-col">
                                            <div className="flex items-end">
                ...
                {/* <div className="bg-white rounded-lg shadow-xl p-8">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 2xl:grid-cols-8 gap-8 mt-8">
                        <a href="#" className="flex flex-col items-center justify-center text-gray-800 hover:text-blue" title="View Profile">
