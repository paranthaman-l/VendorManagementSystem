...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    const getCount = async ()=>{
      await AdminService.getCount().then((response)=>{
        ...
        <div className="pl-32 grid grid-flow-row w-full gap-4 grid-cols-3 min-h-full relative top-0 ">
          <div className="flex group justify-between items-center h-40 w-96 font-nutnitoSans shadow-md hover:-translate-y-2 transition-all  delay-100 ease-in-out rounded-xl bg-white">
            <div className="">
              ...
              <p className="text-4xl  text-start mx-8">{count?.organizationCount}</p>
            </div>
          </div>
          <div className="flex group justify-between items-center h-40 w-96 font-nutnitoSans shadow-md hover:-translate-y-2 transition-all  delay-100 ease-in-out rounded-xl bg-white">
            <div className="">
              ...
              <p className="text-4xl  text-start mx-8">{count?.vendorCount}</p>
            </div>
          </div>
          <div className="flex group justify-between items-center h-40 w-96 font-nutnitoSans shadow-md hover:-translate-y-2 transition-all  delay-100 ease-in-out rounded-xl bg-white">
            <div className="">
              ...
              <p className="text-4xl  text-start mx-8">{count?.contractCount}</p>
            </div>
          </div>
          <div className="flex group justify-between items-center h-40 w-96 font-nutnitoSans shadow-md hover:-translate-y-2 transition-all  delay-100 ease-in-out rounded-xl bg-white">
            <div className="">
