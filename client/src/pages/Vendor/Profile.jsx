...
const Profile = () => {
    ...
    const handleChange = async (url) => {
        if (type === "banner") {
            await VendorService.updateBanner({ id: vendor?.vid, file: url }).then(async (response) => {
            ...
            await VendorService.updateProfile({ id: vendor?.vid, file: url }).then(async (response) => {
                if (response.status == 200) {
                    await VendorService.getVendorData(vendor?.vid).then((res) => {
                        dispatch(setVendor(res.data));
                    ...
                    <div className="flex-1 bg-white rounded-lg w-5/12 shadow-xl p-8">
                        ...
                        <ul className="mt-2 text-gray-700">
                            <li className="flex border-y py-2">
                                ...
                                <span className="text-gray-700">{vendor?.user?.name}</span>
                            </li>
                            ...
                            <li className="flex border-b py-2">
                                ...
                                <span className="text-gray-700">{vendor?.user?.email}</span>
                            </li>
                            <li className="flex border-b py-2">
