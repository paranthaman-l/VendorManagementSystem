...
const UpdateService = ({ addRef, setShowUpdateService,updateService,getService }) => {
                    ...
                    <div className="p-4 col-span-6 md:col-span-4 overflow-y-scroll">
                        <div className="mx-auto grid grid-cols-2 gap-x-8 gap-y-10">
                            ...
                            <div className="col-span-2 sm:col-span-1">
                                ...
                                <div className="mt-2">
                                    <Select name="serviceStatus" value={service.serviceStatus} label="Select Service Status">
                        ...
                        stage === 3 ?
                            ...
                            stage === 4 ?
                                <div className="w-full col-span-2 mt-10">
                                    <div className="flex">
                                        <img src={service.certificate} alt="" />
