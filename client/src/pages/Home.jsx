    ...
    <div className='mt-20 min-h-full flex flex-col items-center'>
      ...
      <div className="flex justify-between px-20 mt-10 w-full items-center">
        <div className="w-7/12">
          <p className='text-5xl font-poppins font-extrabold'>The One Solution for Managing Your Employees</p>
          ...
          <div className="flex justify-evenly w-[90%]  items-center mt-10 ">
            <button className='flex justify-center group items-center bg-blue px-4 py-2 min-w-[180px] min-h-[50px] text-white font-inter font-bold rounded-3xl'>Get Started <BsArrowRight className='ml-4 group-hover:translate-x-2 duration-300 text-xl' /></button>
            <button className='min-w-[250px] min-h-[50px] border-[3px] border-blue text-blue hover:text-hoverBlue flex justify-between items-center pl-5 pr-1 rounded-3xl font-bold font-inter'>What is Delta? <BsFillPlayCircleFill className='text-4xl text-blue' /> </button>
          </div>
        </div>
        <div className="w-5/12 flex justify-center">
          <img className='w-full' src={homepageImage1} alt="" />
        </div>
      </div>
      {/*End of First div */}
      {/* Start of Second div */}
      <div className=" flex flex-col mt-20">
        <p className='flex justify-center text-xl font-poppins font-semibold mb-10'>Trusted by Over 36,000 Companies Worldwide</p>
