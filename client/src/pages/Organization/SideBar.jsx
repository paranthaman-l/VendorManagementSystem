...
import { logout } from "../../slices/organizationSlice";
...
const SideBar = () => {
    ...
    return (
        <nav className=" rounded-md w-72 fixed h-full  flex-col justify-between pb-36">
            <div className=" bg-white h-full ">
                <div className="pl-10">
                    <ul className="space-y-8 pt-10">
                        ...
                        <li onClick={()=>navigate('/organization/requested')} className="flex space-x-4 items-center hover:text-indigo-600 cursor-pointer">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
                                    d="M13 10V3L4 14h7v7l9-11h-7z" />
            ...
            <div onClick={handleLogout} className="bg-white flex items-center space-x-4 pl-10 pb-16  hover:text-indigo-600 cursor-pointer">
